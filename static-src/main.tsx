...
function StaticHeader({ view, navigate }: { view: View; navigate: (view: View) => void }) {
  ...
  return <header className="sticky top-0 z-50 border-b border-line bg-paper/95 backdrop-blur-xl">
...
const criteria = [['01', 'Public sponsor', 'A government body or government-established delivery organization must directly sponsor or steward the work.'], ['02', 'Public source', 'The canonical repository must be accessible without special permission.'], ['03', 'Eligible license', 'An OSI-approved license or clear public-domain dedication is required.'], ['04', 'Primary evidence', 'An official page, verified organization, policy, or procurement record must establish sponsorship.']];

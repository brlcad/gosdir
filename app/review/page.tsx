...
export default function ReviewPage() {
  return <main>
    <PageIntro
      ...
      title="Review the proof, not the pitch."
      description="Inspect open project and policy submissions, verify every eligibility claim, and prepare accepted records for an ordinary reviewed code change. Nothing on this page publishes automatically."

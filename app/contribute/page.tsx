...
const steps = [
  ...
  ['3', 'Verify', 'Editors check sources, dates, wording, links, and duplicates.'],
...
export default function ContributePage() {
  return (
    <main>
      <PageIntro eyebrow="Verified submissions" title="Bring the proof. Help map the work." description="Propose a government-sponsored project, policy source, or timeline milestone. Submissions use public GitHub issues and enter the directory after editorial review." />
      <section className="page-shell grid gap-8 py-14 lg:grid-cols-[1fr_320px] lg:py-18">
        <SubmissionForm mode="contribute" />
